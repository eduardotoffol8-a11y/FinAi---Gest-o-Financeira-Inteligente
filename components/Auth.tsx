      ...
      <div className="w-full max-w-md animate-in fade-in zoom-in duration-500">
        <div className="bg-white rounded-[2.5rem] shadow-2xl border border-slate-200 p-10 relative overflow-hidden">
          ...
          <div className="flex flex-col items-center text-center mb-10">
            ...
            <p className="text-slate-500 font-medium mt-2">Plataforma de Comando Neural</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-4">
               <input 
                  ...
                  className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 font-medium focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all"
               />
               <input 
                  type="password" 
            ...
            <button type="submit" className="w-full bg-slate-900 hover:bg-slate-800 text-white font-bold py-5 rounded-2xl shadow-xl transition-all flex items-center justify-center gap-2 uppercase tracking-widest text-xs">
              Iniciar Sessão <ArrowRight className="w-5 h-5" />
            </button>
          </form>
        </div>
      </div>
